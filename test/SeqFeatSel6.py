...
import pickle
expnumbers = [10,14,15,16,17,19,20,21,22,24,25,27,28]
result = []
...
plt.title("Sequential feature selection: step 6")
plt.tight_layout()
plt.savefig("/work/FAC/FGSE/IDYST/tbeucler/downscaling/alecler1/plots/R_VGAM/DiagnosticsVal/SeqFeatSel6.png")
with open("/work/FAC/FGSE/IDYST/tbeucler/downscaling/alecler1/plots/R_VGAM/DiagnosticsVal/SeqFeatSel6.pkl", "wb") as f:
    pickle.dump(df, f)
plt.close()