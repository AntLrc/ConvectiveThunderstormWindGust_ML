...
import pickle
expnumbers = [10, 11, 12, 14, 15, 16, 17, 19, 20, 21, 24, 25, 26, 27, 28]
result = []
...
plt.title("Sequential feature selection: step 5")
plt.tight_layout()
plt.savefig("/work/FAC/FGSE/IDYST/tbeucler/downscaling/alecler1/plots/R_VGAM/DiagnosticsVal/SeqFeatSel5.png")
with open("/work/FAC/FGSE/IDYST/tbeucler/downscaling/alecler1/plots/R_VGAM/DiagnosticsVal/SeqFeatSel5.pkl", "wb") as f:
    pickle.dump(df, f)
plt.close()