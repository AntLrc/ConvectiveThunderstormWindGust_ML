...
import pickle
expnumbers = [10,12, 14,15,16,17,18,19,20,21,23,24,25,26,27,28]
result = []
...
plt.title("Sequential feature selection: step 4")
plt.tight_layout()
plt.savefig("/work/FAC/FGSE/IDYST/tbeucler/downscaling/alecler1/plots/R_VGAM/DiagnosticsVal/SeqFeatSel4.png")
with open("/work/FAC/FGSE/IDYST/tbeucler/downscaling/alecler1/plots/R_VGAM/DiagnosticsVal/SeqFeatSel4.pkl", "wb") as f:
    pickle.dump(df, f)
plt.close()